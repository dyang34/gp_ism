    ...
    ?>                        
            <li class="">
                ...
                <div class="subMenu">
    				...
    				<a href="/ism/admin/adm_order_list.php" class="<?=$menuNo==25?"on":""?>">- 판매 내역 작업</a>
    ...
    ?>                        
            <li class="">
                ...
                <div class="subMenu">
    				...
    				<a href="/ism/admin/upload_wholesales_data.php" class="<?=$menuNo==26?"on":""?>">- 도매 판매 업로드</a>
    				<a href="/ism/admin/wholesale_customer_list.php" class="<?=$menuNo==27?"on":""?>">- 도매 거래처 관리</a>
    			</div>
            </li>
    <?php
    }
    ...
    ?>
            <li>
                ...
                <div class="subMenu">
                    ...
                    <a href="/ism/admin/goods_item_missing_list.php " class="<?=$menuNo==29?"on":""?>"><font color='red'>&nbsp&nbsp- 누락 품목 관리</font></a>
                    <a href="/ism/admin/brand_list.php " class="<?=$menuNo==5?"on":""?>">- 브랜드 관리</a>
                    <a href="/ism/admin/category_list.php " class="<?=$menuNo==6?"on":""?>">- 카테고리 관리</a>
                    <a href="/ism/admin/customer_list.php " class="<?=$menuNo==28?"on":""?>">- 거래처 관리</a>
                    <a href="/ism/admin/channel_list_view.php " class="<?=$menuNo==7?"on":""?>">- 거래처 리스트</a>
                </div>
            </li>
    <?php
    }
