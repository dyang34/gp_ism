...
<html lang="ko">
    <head>
        ...
        <link rel="shortcut icon" href="/ism/images/common/favicon.ico?" />
        <link rel="apple-touch-icon-precomposed" href="/ism/images/common/apple-favicon.png?"/>
        ...
        <script type="text/javascript" src="/ism/js/common.js"></script>
    </head>