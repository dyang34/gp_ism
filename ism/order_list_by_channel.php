...
$_grp_channel = RequestUtil::getParam("_grp_channel", "grp_channel");
    ...
    <input type="hidden" name="_grp_order_type" value="<?=$_grp_order_type?>">
            ...
            <div>
                <div style="padding-left:20px;">
                    <h3 class="icon-search">채널별 집계</h3>
                    <ul class="icon_Btn">
                        <li><a href="#" name="btnExcelDownload">엑셀</a></li>
                    </ul>
                </div>
				<form name="searchForm" method="get" action="order_list_by_channel.php">
...
$(document).on('click','a[name=btnExcelDownload]', function() {
	...
	f.target = "_new";
	f.action = "order_list_by_channel_xls.php";
...
var goPage = function(page) {
	...
	f.action = "order_list_by_channel.php";
	f.submit();
}
