...
Header("Content-Disposition: attachment; filename=ISM_카테고리별 집계(".$_order_date_from."_".$_order_date_to.")_".date('Ymd').".xls");
...
?>
                    ...
                    <tr>
                        <td class="txt_c"><?=substr($row["order_date"],0,10)?></td>
