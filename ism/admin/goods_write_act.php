...
//        if (empty($userid)) {
        ...
        GoodsMgr::getInstance()->add_check(array("item_code"=>$item_code,"code"=>$code));
...
//        if (empty($rm_name)) {
        ...
        $row_data = GoodsMgr::getInstance()->getByKey($item_code);
...
//        if (empty($userid)) {
        ...
        GoodsMgr::getInstance()->delete($item_code);
