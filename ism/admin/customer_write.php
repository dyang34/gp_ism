...
?>
                            ...
                            <tr>
                                ...
                                <td class="wrt_radio_box">
                                    <input type="radio" id="imc_fg_supply2" value="1" <?=$row["imc_fg_supply"]!="0"?"checked":""?> name="imc_fg_supply">
                                    <label for="imc_fg_supply2" class="sameR" style="margin-right:26px;">공급합계</label>
									<input type="radio" id="imc_fg_supply1" value="0" <?=$row["imc_fg_supply"]=="0"?"checked":""?> name="imc_fg_supply">
                                    <label for="imc_fg_supply1" class="newR">결제금액</label>
